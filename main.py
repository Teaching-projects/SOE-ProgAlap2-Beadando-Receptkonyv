...
class SzakacskonyvGUI(tk.Tk):
    ...
    def __setup_ui(self):
        ...
        self.button2 = tk.Button(self.menu_frame,text="BEVASARLOLISTA",  relief=tk.RAISED, width= 20, height= 3, bg= "gray20", command= lambda: self.page("BEVASARLOLISTA"),foreground="cyan")
        ...
        self.button2.pack(side=tk.TOP, fill=tk.X, pady=10, padx=10)
