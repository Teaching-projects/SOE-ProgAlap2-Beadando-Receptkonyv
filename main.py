...
class SzakacskonyvGUI(tk.Tk):
    ...
    def page(self,page):
        ...
        if page == "NAPTAR":
            ...
            def button_press(text):
                ...
                print(self.event)
                self.layer["Group0Buttons"].append(tk.Button(self.layer["Group"][2],text="Uj Event",bg="gray20", foreground="magenta"))
            ...
            def spawn_naptar(config):
                ...
                self.naptar.event("2021-06-18","Babgulyas")
    ...
    def hozzavaloszerkeszto(self,mode):
        ...
        "Ez a függvény hozza létre a Receptkezelo / UJ REPECT / Hozzavalok részt."
